...
public class BrightcovePlayerPosterManager
  extends SimpleViewManager<BrightcovePlayerPosterView> {
  ...
  public BrightcovePlayerPosterView createViewInstance(ThemedReactContext ctx) {
    context = ctx;
    BrightcovePlayerPosterView brightcovePlayerPosterView = new BrightcovePlayerPosterView(
      ctx,
      applicationContext
    );
  ...
  public void setReferenceId(
    BrightcovePlayerPosterView view,
    String referenceId
  ) {
