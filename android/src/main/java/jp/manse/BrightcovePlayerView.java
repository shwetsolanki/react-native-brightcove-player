...
public class BrightcovePlayerView
  ...
  public BrightcovePlayerView(
    ...
    this.playerVideoView = new BrightcoveExoPlayerVideoView(
      this.context.getCurrentActivity()
    );

    this.addView(this.playerVideoView);
    this.playerVideoView.setLayoutParams(
    ...
    final BrightcoveMediaControlRegistry registry = this.playerVideoView.getBrightcoveMediaController(

    ).getMediaControlRegistry();
    ((SeekButtonController) registry.getButtonController(
      R.id.rewind
    )).setSeekDefault(SEEK_AMOUNT);
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            ...
            BrightcovePlayerManager.EVENT_READY,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          mediaInfo.putString(
            "title",
            BrightcovePlayerView.this.mediaInfo.get("name").toString()
          );
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_METADATA_LOADED,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_PLAY,
            event
          );
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_PAUSE,
            event
          );
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_END,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          WritableMap event = Arguments.createMap();
          Integer playhead = (Integer) e.properties.get(
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_PROGRESS,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_BEFORE_ENTER_FULLSCREEN,
            Arguments.createMap()
          );
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_ENTER_FULLSCREEN,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_BEFORE_EXIT_FULLSCREEN,
            Arguments.createMap()
          );
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_EXIT_FULLSCREEN,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_CHANGE_DURATION,
            event
          );
        }
    ...
    eventEmitter.on(
      EventType.BUFFERED_UPDATE,
      new EventListener() {

        @Override
        public void processEvent(Event e) {
          Integer percentComplete = (Integer) e.properties.get(
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_UPDATE_BUFFER_PROGRESS,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_BUFFERING_STARTED,
            event
          );
        }
    ...
    eventEmitter.on(
      ...
      new EventListener() {
        ...
        public void processEvent(Event e) {
          ...
          reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
            BrightcovePlayerView.this.getId(),
            BrightcovePlayerManager.EVENT_BUFFERING_COMPLETED,
            event
          );
        }
  ...
  public void setFullscreen(boolean fullscreen) {
    ...
    reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(
      BrightcovePlayerView.this.getId(),
      fullscreen ? BrightcovePlayerManager.EVENT_ENTER_FULLSCREEN : BrightcovePlayerManager.EVENT_EXIT_FULLSCREEN,
      event
    );
  }
  ...
  private void updateBitRate() {
    ...
    for (int i = 0; i < mappedTrackInfo.length; i++) {
      ...
      if (trackGroups.length != 0 && player.getRendererType(
        i
      ) == C.TRACK_TYPE_VIDEO) {
        rendererIndex = i;
        break;
    ...
    for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
      ...
      if (group != null) {
        for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
          ...
          if (format != null && mappedTrackInfo.getTrackFormatSupport(
            rendererIndex,
            groupIndex,
            trackIndex
          ) == RendererCapabilities.FORMAT_HANDLED) {
            if (resultBitRate == -1 || (resultBitRate > bitRate ? (format.bitrate < resultBitRate) : (format.bitrate <= bitRate && format.bitrate > resultBitRate))) {
  ...
  private void updatePlaybackRate() {
    ExoPlayer expPlayer = ((ExoPlayerVideoDisplayComponent) this.playerVideoView.getVideoDisplay(
