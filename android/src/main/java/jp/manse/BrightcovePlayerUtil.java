...
public class BrightcovePlayerUtil
  extends ReactContextBaseJavaModule
  implements
    BrightcovePlayerAccount.OnBrightcovePlayerAccountListener {
  ...
  private List<
    BrightcovePlayerAccount
  > brightcovePlayerAccounts = new ArrayList<>();
  ...
  @ReactMethod
  public void requestDownloadVideoWithReferenceId(
    String referenceId,
    String accountId,
    String policyKey,
    int bitRate,
    ...
    BrightcovePlayerAccount account = this.getBrightcovePlayerAccount(
      accountId,
      policyKey
    );
    if (account == null) {
  ...
  @ReactMethod
  public void requestDownloadVideoWithVideoId(
    String videoId,
    String accountId,
    String policyKey,
    int bitRate,
  ...
  @ReactMethod
  public void getOfflineVideoStatuses(
    String accountId,
    String policyKey,
    Promise promise
  ) {
  ...
  private void sendOfflineNotification(NativeArray array) {
    ...
    ).emit(CALLBACK_OFFLINE_NOTIFICATION, array);
  }

  private BrightcovePlayerAccount getBrightcovePlayerAccount(
    String accountId,
    String policyKey
  ) {
    ...
    BrightcovePlayerAccount owner = new BrightcovePlayerAccount(
